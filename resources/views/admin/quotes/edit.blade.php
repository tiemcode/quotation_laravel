<x-app-layout>
    ...
    <div class="card" style="width:85%;">
        <h1 class="card-header ">Offerte aanpassen</h1>
        <div class="card-body">
            <form action="{{ route('quotes.update', $quote) }}" enctype="multipart/form-data" method="post">
                @method('PUT')
                @csrf
                <div class="mb-3">
                ...
                <x-input-field type="text" :value="$quote->quotes_number" name="number" label="Offerte nummer"></x-input-field>
                <x-textarea name="desc" label="Inhoud" :value="$quote->description"></x-textarea>
